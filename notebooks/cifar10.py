...
cifar_10_dataset_dir = "DL_cyber_attacks\datasets\CIFAR10\cifar-10-batches-py"
output_dir = "DL_cyber_attacks\datasets\CIFAR10\cifar-10"
...
np.save("DL_cyber_attacks/datasets/CIFAR10/cifar-10/train/data", x_train)
np.save("DL_cyber_attacks/datasets/CIFAR10/cifar-10/train/labels", y_train)
...
np.save("DL_cyber_attacks/datasets/CIFAR10/cifar-10/test/data", x_test)
np.save("DL_cyber_attacks/datasets/CIFAR10/cifar-10/test/labels", y_test)
