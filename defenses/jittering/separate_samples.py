...
def separate_samples(arg, trainloader, model, gamma_low, gamma_high):
    ...
    clean_samples = np.array(clean_samples, dtype=object)
    poison_samples = np.array(poison_samples, dtype=object)
    suspicious_samples = np.array(suspicious_samples, dtype=object)
